			...
			<div class="formulario1">
				<form class="form-horizontal" action="adicionaBanda" role="form" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" name="qtdMembros" id="qtdMembros" placeholder="quantidade de membros" min="1" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="tel" class="form-control" name="telefone" id="telefone" placeholder="informe um telefone p/ contato" maxlength="14" required />
							</div>
						</div>
